"""
Django settings for foodxchange project.
"""
...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-default-dev-key-x')

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = os.getenv('DEBUG', 'True').lower() in ('true', '1', 'yes')

ALLOWED_HOSTS = os.getenv('ALLOWED_HOSTS', 'localhost,127.0.0.1,192.168.1.107,192.168.56.1,192.168.0.80,172.26.210.115,192.168.1.80').split(',')
...
WSGI_APPLICATION = 'foodxchange.wsgi.application'
